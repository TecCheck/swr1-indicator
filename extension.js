    ...
    class Indicator extends PanelMenu.Button {
        _init() {
            ...
            item2.connect('activate', () => {
                this.openUrlInBrowser('https://www.swr.de/swr1/bw/uebersicht-swr1-bw-100.html')
            });
        ...
        fetchData() {
            let promise = this.loadJsonAsync("https://api.lab.swr.de/radiohub/v2/track/list/swr1bw")
            promise.then(json => this.onDataFetched(json)).catch(error => this.onDataFetchError(error));
        }
        ...
        onDataFetchError(error) {
            ...
            this._currentFetchTimer = setTimeout(() => this.fetchData(), 1000);
        }
        ...
        sheduleNextFetch(song) {
            ...
            let timeUntilNextRequest = predictedSongTimeLeft;
            ...
            this._currentFetchTimer = setTimeout(() => this.fetchData(), timeUntilNextRequest);
        }
    });
...
class Extension {
    ...
    disable() {
        clearTimeout(this._currentFetchTimer);
